...
describe('Elliptic Curve Cryptography', function () {
  ...
  describe('Basic Operations', function () {
    ...
    it('Shared secret generation', function (done) {
      ...
      const shared1 = key1.derive(key2).toString(16);//openpgp.util.Uint8Array_to_hex(key1.derive(key2));
      key1 = curve.keyFromPublic(key_data.p256.pub);
      key2 = curve.keyFromPrivate(signature_data.priv);
      const shared2 = key2.derive(key1).toString(16);//openpgp.util.Uint8Array_to_hex(key2.derive(key1));
